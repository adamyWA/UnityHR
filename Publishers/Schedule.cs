...
public class Schedule : MonoBehaviour {
	...
	void Start () {
        ...
        new OpenShift { Day = DayOfWeek.Monday, Shift = Shift.Morning, RequiredTitle = Title.Salesperson },
        new OpenShift { Day = DayOfWeek.Monday, Shift = Shift.Morning, RequiredTitle = Title.Salesperson },
        ...
        new OpenShift { Day = DayOfWeek.Tuesday, Shift = Shift.Morning, RequiredTitle = Title.Salesperson },
        new OpenShift { Day = DayOfWeek.Tuesday, Shift = Shift.Morning, RequiredTitle = Title.Salesperson },
        ...
        new OpenShift { Day = DayOfWeek.Wednesday, Shift = Shift.Morning, RequiredTitle = Title.Salesperson },
        new OpenShift { Day = DayOfWeek.Wednesday, Shift = Shift.Morning, RequiredTitle = Title.Salesperson },
        ...
        new OpenShift { Day = DayOfWeek.Thursday, Shift = Shift.Morning, RequiredTitle = Title.Salesperson },
        new OpenShift { Day = DayOfWeek.Thursday, Shift = Shift.Morning, RequiredTitle = Title.Salesperson },
        ...
        new OpenShift { Day = DayOfWeek.Friday, Shift = Shift.Morning, RequiredTitle = Title.Salesperson },
        new OpenShift { Day = DayOfWeek.Friday, Shift = Shift.Morning, RequiredTitle = Title.Salesperson },
